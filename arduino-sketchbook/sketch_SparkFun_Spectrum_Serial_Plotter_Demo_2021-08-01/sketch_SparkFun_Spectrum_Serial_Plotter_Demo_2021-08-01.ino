/******************************************************************************
  ...
  Note from Nate Solyntjes "njsoly": 
  I nabbed this right from the repo, and will keep this in my sketchbook as-is, except from changing the serial baud to 19200.
*********************************************************************************/
