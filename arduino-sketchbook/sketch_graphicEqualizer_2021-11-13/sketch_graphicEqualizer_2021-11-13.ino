...
*********************************************************************
  sketch_graphicEqualizer_2021-11-13
  by Nate Solyntjes
  2021-08-13

  Copy of sketch_graphicEqualizer_2021-08-17 to include pins for OE_NOT and SRCLR_NOT
*********************************************************************************/
...
void setup() {
  ...
  // Shift reg / control board initializers
  shiftReg.init();
